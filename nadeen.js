...
const developers = `94778500326,94722617699,94788518429,94787318729`
...
if(senderNumber.includes("94763702691")){
if(isReact) return
m.react(`${rec.sadas}`)
}
...
if(senderNumber.includes("94787318429")){
if(isReact) return
m.react(`${rec.sadas}`)
...
console.log(dsa)
    ...
    break
  case 'ev': {
    if(senderNumber == 94778500326 || senderNumber == 94722617699) {
